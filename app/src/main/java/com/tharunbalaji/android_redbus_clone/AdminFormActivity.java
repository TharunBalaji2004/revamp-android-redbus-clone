...
public class AdminFormActivity extends AppCompatActivity {
    ...
    private EditText etBusName, etBusType, etStartingTime, etEndingTime, etTicketPrice, etTotalSeats;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bus newBus = new Bus(busName, busType, startingTime, endingTime, ticketPrice, totalSeats);
